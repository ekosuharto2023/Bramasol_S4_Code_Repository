class ZCL_ZODQ_PAYPROPITM_01_DPC_1 definition
  public
...
CLASS ZCL_ZODQ_PAYPROPITM_01_DPC_1 IMPLEMENTATION.


  method CLASS_CONSTRUCTOR.
  DATA: ls_odp TYPE cl_rsodp_odata_odp_out_mpc=>ts_odp.
  ps_service_config-model_name      = 'ZODQ_PAYPROPITMAGGRGN_1_MDL_01'.
  ps_service_config-model_version   = '0001'.
  ps_service_config-service_name    = 'ZODQ_PAYPROPITMAGGRGN_1_SRV_01'.
  ps_service_config-service_version = '0001'.
  ps_service_config-mpc_name        = 'ZCL_ZODQ_PAYPROPITM_01_MPC_1'.
  ps_service_config-dpc_name        = 'ZCL_ZODQ_PAYPROPITM_01_DPC_1'.
  ps_service_config-context         = 'ABAP_CDS'.
  CLEAR ps_service_config-odps.
  ls_odp-odpname    = 'ZVPAYTITMAGGRGN$F'.
  ls_odp-entityname = 'FactsOfZVPAYTITMAGGRGN'.
