class ZCL_ZODQ_PREPMNTSETTLT_MPC definition
  public
...
CLASS ZCL_ZODQ_PREPMNTSETTLT_MPC IMPLEMENTATION.
...
* Extend the model
model->extend_model( iv_model_name = 'ZODQ_PREPMNTSETTLTDT_2_MDL' iv_model_version = '0001' ). "#EC NOTEXT

model->set_schema_namespace( 'ZODQ_PREPMNTSETTLTDT_SRV' ).
  endmethod.
...
ev_extended_service  = 'ZODQ_PREPMNTSETTLTDT_2_SRV'.                "#EC NOTEXT
ev_ext_service_version = '0001'.               "#EC NOTEXT
ev_extended_model    = 'ZODQ_PREPMNTSETTLTDT_2_MDL'.                    "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  constants: lc_gen_date_time type timestamp value '20250811112017'. "#EC NOTEXT
