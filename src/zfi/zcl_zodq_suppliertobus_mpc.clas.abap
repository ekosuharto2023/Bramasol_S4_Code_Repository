class ZCL_ZODQ_SUPPLIERTOBUS_MPC definition
  public
...
public section.
  ...
  types:
  begin of TS_ATTROFICVIVENDLINK,
     BUSINESSPARTNERUUID type string,
     SUPPLIER type C length 10,
     ODQ_CHANGEMODE type C length 1,
     ODQ_ENTITYCNTR type DECFLOAT34,
  end of TS_ATTROFICVIVENDLINK .
  types:
TT_ATTROFICVIVENDLINK type standard table of TS_ATTROFICVIVENDLINK .
  types:
  begin of TS_DELTALINKSOFATTROFICVIVENDL,
     DELTA_TOKEN type string,
     CREATED_AT type TIMESTAMP,
     IS_INITIAL_LOAD type FLAG,
  end of TS_DELTALINKSOFATTROFICVIVENDL .
  types:
TT_DELTALINKSOFATTROFICVIVENDL type standard table of TS_DELTALINKSOFATTROFICVIVENDL .

  constants GC_ATTROFICVIVENDLINK type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'AttrOfICVIVENDLINK' ##NO_TEXT.
  ...
  constants GC_DELTALINKSOFATTROFICVIVENDL type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'DeltaLinksOfAttrOfICVIVENDLINK' ##NO_TEXT.
...
CLASS ZCL_ZODQ_SUPPLIERTOBUS_MPC IMPLEMENTATION.
...
* Extend the model
model->extend_model( iv_model_name = 'ZODQ_SUPPLIERTOBUSINESSPARTNER_1' iv_model_version = '0001' ). "#EC NOTEXT

model->set_schema_namespace( 'ZODQ_SUPPLIERTOBUSINESSPARTNER_SRV' ).
  endmethod.
...
ev_extended_service  = 'ZODQ_SUPPLIERTOBUSINESSPARTNER_1_SR'.                "#EC NOTEXT
ev_ext_service_version = '0001'.               "#EC NOTEXT
ev_extended_model    = 'ZODQ_SUPPLIERTOBUSINESSPARTNER_1'.                    "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  constants: lc_gen_date_time type timestamp value '20250801172411'. "#EC NOTEXT
