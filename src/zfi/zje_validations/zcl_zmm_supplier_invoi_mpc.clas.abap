class ZCL_ZMM_SUPPLIER_INVOI_MPC definition
  public
...
TT_WITHHOLDINGTAX type standard table of TS_WITHHOLDINGTAX .
  types:
     TS_ZI_FI_INVOICECATEGORY type ZFI_INV_CATEGORY .
  types:
TT_ZI_FI_INVOICECATEGORY type standard table of TS_ZI_FI_INVOICECATEGORY .
  ...
  constants GC_ZI_FI_INVOICECATEGORY type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZI_FI_InvoiceCategory' ##NO_TEXT.
...
CLASS ZCL_ZMM_SUPPLIER_INVOI_MPC IMPLEMENTATION.
...
***********************************************************************************************************************************
*   ENTITY - ZI_FI_InvoiceCategory
***********************************************************************************************************************************
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ZI_FI_InvoiceCategory' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZFI_INV_CATEGORY'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_type = model->get_entity_type( iv_entity_name = 'ZI_FI_InvoiceCategory' ). "#EC NOTEXT
lo_entity_set = lo_entity_type->create_entity_set( 'ZI_FI_InvoiceCategorySet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  constants: lc_gen_date_time type timestamp value '20260403151327'. "#EC NOTEXT
