class ZCL_ZMM_SUPPLIER_IN_02_MPC definition
  public
...
CLASS ZCL_ZMM_SUPPLIER_IN_02_MPC IMPLEMENTATION.
...
*&---------------------------------------------------------------------*
  ...
  constants: lc_gen_date_time type timestamp value '20260408194721'. "#EC NOTEXT
