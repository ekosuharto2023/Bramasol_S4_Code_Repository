class ZCL_ZODQ_GLACCTINCOMPA_DPC_4 definition
  public
...
CLASS ZCL_ZODQ_GLACCTINCOMPA_DPC_4 IMPLEMENTATION.


  method CLASS_CONSTRUCTOR.
  DATA: ls_odp TYPE cl_rsodp_odata_odp_out_mpc=>ts_odp.
  ps_service_config-model_name      = 'ZODQ_GLACCTINCOMPANYCODE_4_MDL'.
  ps_service_config-model_version   = '0001'.
  ps_service_config-service_name    = 'ZODQ_GLACCTINCOMPANYCODE_4_SRV'.
  ps_service_config-service_version = '0001'.
  ps_service_config-mpc_name        = 'ZCL_ZODQ_GLACCTINCOMPA_MPC_4'.
  ps_service_config-dpc_name        = 'ZCL_ZODQ_GLACCTINCOMPA_DPC_4'.
  ps_service_config-context         = 'ABAP_CDS'.
  CLEAR ps_service_config-odps.
  ls_odp-odpname    = 'IFIGLACCINCCODE$P'.
  ls_odp-entityname = 'AttrOfIFIGLACCINCCODE'.
