class ZCL_ZODQ_EXCHANGERA_01_MPC_1 definition
  public
...
CLASS ZCL_ZODQ_EXCHANGERA_01_MPC_1 IMPLEMENTATION.


  method CLASS_CONSTRUCTOR.
  DATA: ls_odp TYPE ts_odp.
  ps_service_config-model_name      = 'ZODQ_EXCHANGERATE_1_MDL_01'.
  ps_service_config-model_version   = '0001'.
  ps_service_config-service_name    = 'ZODQ_EXCHANGERATE_1_SRV_01'.
  ps_service_config-service_version = '0001'.
  ps_service_config-mpc_name        = 'ZCL_ZODQ_EXCHANGERA_01_MPC_1'.
  ps_service_config-dpc_name        = 'ZCL_ZODQ_EXCHANGERA_01_DPC_1'.
