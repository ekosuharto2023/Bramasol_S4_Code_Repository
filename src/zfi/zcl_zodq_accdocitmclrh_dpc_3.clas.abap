class ZCL_ZODQ_ACCDOCITMCLRH_DPC_3 definition
  public
...
CLASS ZCL_ZODQ_ACCDOCITMCLRH_DPC_3 IMPLEMENTATION.


  method CLASS_CONSTRUCTOR.
  DATA: ls_odp TYPE cl_rsodp_odata_odp_out_mpc=>ts_odp.
  ps_service_config-model_name      = 'ZODQ_ACCDOCITMCLRHIST_3_MDL'.
  ps_service_config-model_version   = '0001'.
  ps_service_config-service_name    = 'ZODQ_ACCDOCITMCLRHIST_3_SRV'.
  ps_service_config-service_version = '0001'.
  ps_service_config-mpc_name        = 'ZCL_ZODQ_ACCDOCITMCLRH_MPC_3'.
  ps_service_config-dpc_name        = 'ZCL_ZODQ_ACCDOCITMCLRH_DPC_3'.
  ps_service_config-context         = 'ABAP_CDS'.
  CLEAR ps_service_config-odps.
  ls_odp-odpname    = 'I_OPLACCTGDOCITEMCLRGHIST$P'.
  ls_odp-entityname = 'AttrOfI_OPLACCTGDOCITEMCLRGHIST'.
