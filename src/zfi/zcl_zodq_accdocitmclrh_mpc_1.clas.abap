class ZCL_ZODQ_ACCDOCITMCLRH_MPC_1 definition
  public
...
CLASS ZCL_ZODQ_ACCDOCITMCLRH_MPC_1 IMPLEMENTATION.


  method CLASS_CONSTRUCTOR.
  DATA: ls_odp TYPE ts_odp.
  ps_service_config-model_name      = 'ZODQ_ACCDOCITMCLRHIST_1_MDL'.
  ps_service_config-model_version   = '0001'.
  ps_service_config-service_name    = 'ZODQ_ACCDOCITMCLRHIST_1_SRV'.
  ps_service_config-service_version = '0001'.
  ps_service_config-mpc_name        = 'ZCL_ZODQ_ACCDOCITMCLRH_MPC_1'.
  ps_service_config-dpc_name        = 'ZCL_ZODQ_ACCDOCITMCLRH_DPC_1'.
