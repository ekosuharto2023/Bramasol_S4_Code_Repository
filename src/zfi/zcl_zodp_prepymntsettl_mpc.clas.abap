class ZCL_ZODP_PREPYMNTSETTL_MPC definition
  public
...
public section.
  ...
  types:
  begin of TS_DELTALINKSOFFACTSOFZVPPMTST,
     DELTA_TOKEN type string,
     CREATED_AT type TIMESTAMP,
     IS_INITIAL_LOAD type FLAG,
  end of TS_DELTALINKSOFFACTSOFZVPPMTST .
  types:
TT_DELTALINKSOFFACTSOFZVPPMTST type standard table of TS_DELTALINKSOFFACTSOFZVPPMTST .
  types:
  begin of TS_FACTSOFZVPPMTSTLDT,
     ...
     SETTLEMENTPOSTINGDATE type TIMESTAMP,
     ODQ_CHANGEMODE type C length 1,
     ODQ_ENTITYCNTR type DECFLOAT34,
  end of TS_FACTSOFZVPPMTSTLDT .
  types:
TT_FACTSOFZVPPMTSTLDT type standard table of TS_FACTSOFZVPPMTSTLDT .
  ...
  constants GC_DELTALINKSOFFACTSOFZVPPMTST type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'DeltaLinksOfFactsOfZVPPMTSTLDT' ##NO_TEXT.
  constants GC_FACTSOFZVPPMTSTLDT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'FactsOfZVPPMTSTLDT' ##NO_TEXT.
...
CLASS ZCL_ZODP_PREPYMNTSETTL_MPC IMPLEMENTATION.
...
* Extend the model
model->extend_model( iv_model_name = 'ZODP_PREPYMNTSETTLTDT_1_MDL' iv_model_version = '0001' ). "#EC NOTEXT

model->set_schema_namespace( 'ZODP_PREPYMNTSETTLTDT_SRV' ).
  endmethod.
...
ev_extended_service  = 'ZODP_PREPYMNTSETTLTDT_1_SRV'.                "#EC NOTEXT
ev_ext_service_version = '0001'.               "#EC NOTEXT
ev_extended_model    = 'ZODP_PREPYMNTSETTLTDT_1_MDL'.                    "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  constants: lc_gen_date_time type timestamp value '20250811104749'. "#EC NOTEXT
