class ZCL_ZODATA_MOVEFILES_DPC definition
  public
...
protected section.
  ...
  methods FILESET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZODATA_MOVEFILES_MPC=>TS_FILE
    raising
  ...
  methods FILESET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZODATA_MOVEFILES_MPC=>TT_FILE
...
CLASS ZCL_ZODATA_MOVEFILES_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 08.10.2025 07:10:34 in client 210
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZODATA_MOVEFILES_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA fileset_create_entity TYPE zcl_zodata_movefiles_mpc=>ts_file.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA fileset_get_entity TYPE zcl_zodata_movefiles_mpc=>ts_file.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZODATA_MOVEFILES_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA fileset_get_entityset TYPE zcl_zodata_movefiles_mpc=>tt_file.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA fileset_update_entity TYPE zcl_zodata_movefiles_mpc=>ts_file.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
