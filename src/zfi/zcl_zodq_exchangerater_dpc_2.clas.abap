class ZCL_ZODQ_EXCHANGERATER_DPC_2 definition
  public
...
CLASS ZCL_ZODQ_EXCHANGERATER_DPC_2 IMPLEMENTATION.


  method CLASS_CONSTRUCTOR.
  DATA: ls_odp TYPE cl_rsodp_odata_odp_out_mpc=>ts_odp.
  ps_service_config-model_name      = 'ZODQ_EXCHANGERATERAWDATA_2_MDL'.
  ps_service_config-model_version   = '0001'.
  ps_service_config-service_name    = 'ZODQ_EXCHANGERATERAWDATA_2_SRV'.
  ps_service_config-service_version = '0001'.
  ps_service_config-mpc_name        = 'ZCL_ZODQ_EXCHANGERATER_MPC_2'.
  ps_service_config-dpc_name        = 'ZCL_ZODQ_EXCHANGERATER_DPC_2'.
  ps_service_config-context         = 'ABAP_CDS'.
  CLEAR ps_service_config-odps.
  ls_odp-odpname    = 'ZVEXCHRATESREAD$F'.
  ls_odp-entityname = 'FactsOfZVEXCHRATESREAD'.
