class ZCL_ZODQ_SUPPLIERINVOI_DPC_1 definition
  public
...
CLASS ZCL_ZODQ_SUPPLIERINVOI_DPC_1 IMPLEMENTATION.


  method CLASS_CONSTRUCTOR.
  DATA: ls_odp TYPE cl_rsodp_odata_odp_out_mpc=>ts_odp.
  ps_service_config-model_name      = 'ZODQ_SUPPLIERINVOICE_1_MDL'.
  ps_service_config-model_version   = '0001'.
  ps_service_config-service_name    = 'ZODQ_SUPPLIERINVOICE_1_SRV'.
  ps_service_config-service_version = '0001'.
  ps_service_config-mpc_name        = 'ZCL_ZODQ_SUPPLIERINVOI_MPC_1'.
  ps_service_config-dpc_name        = 'ZCL_ZODQ_SUPPLIERINVOI_DPC_1'.
  ps_service_config-context         = 'ABAP_CDS'.
  CLEAR ps_service_config-odps.
  ls_odp-odpname    = 'ZVSUPPLIERINV$F'.
  ls_odp-entityname = 'FactsOfZVSUPPLIERINV'.
