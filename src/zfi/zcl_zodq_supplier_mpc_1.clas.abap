class ZCL_ZODQ_SUPPLIER_MPC_1 definition
  public
...
CLASS ZCL_ZODQ_SUPPLIER_MPC_1 IMPLEMENTATION.


  method CLASS_CONSTRUCTOR.
  DATA: ls_odp TYPE ts_odp.
  ps_service_config-model_name      = 'ZODQ_SUPPLIER_1_MDL'.
  ps_service_config-model_version   = '0001'.
  ps_service_config-service_name    = 'ZODQ_SUPPLIER_1_SRV'.
  ps_service_config-service_version = '0001'.
  ps_service_config-mpc_name        = 'ZCL_ZODQ_SUPPLIER_MPC_1'.
  ps_service_config-dpc_name        = 'ZCL_ZODQ_SUPPLIER_DPC_1'.
  ps_service_config-context         = 'ABAP_CDS'.
  CLEAR ps_service_config-odps.
  ls_odp-odpname    = 'I_SUPPLIER_CDS$P'.
  ls_odp-entityname = 'AttrOfI_SUPPLIER_CDS'.
